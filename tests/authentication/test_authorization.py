...
class TestClassAuthorization:
    ...
    def test_successful_authorization(
        ...
        registration_page.registration_form.fill(email="test@gmail.com", username="username", password="password")
    ...
    def test_navigate_from_authorization_to_registration_page(
