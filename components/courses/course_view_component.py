...
class CourseViewComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.title = self.page.get_by_test_id("course-widget-title-text")
        self.image = self.page.get_by_test_id("course-preview-image")
        self.max_score_text = self.page.get_by_test_id("course-max-score-info-row-view-text")
        self.min_score_text = self.page.get_by_test_id("course-min-score-info-row-view-text")
        self.estimated_time_text = self.page.get_by_test_id("course-estimated-time-info-row-view-text")
