...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_max_text = self.page.get_by_test_id("course-max-score-info-row-view-text")
        self.course_min_text = self.page.get_by_test_id("course-min-score-info-row-view-text")
        self.course_estimated_time_text = self.page.get_by_test_id("course-estimated-time-info-row-view-text")

        self.course_menu_button = self.page.get_by_test_id("course-view-menu-button")
        self.courses_edit_menu_button = self.page.get_by_test_id("course-view-edit-menu-item")
        self.course_delete_menu_button = self.page.get_by_test_id("course-view-delete-menu-item")

        self.empty_view_icon = self.page.get_by_test_id("courses-list-empty-view-icon")
        self.empty_view_title = self.page.get_by_test_id("courses-list-empty-view-title-text")
        self.empty_view_description = self.page.get_by_test_id("courses-list-empty-view-description-text")
    ...
    def check_visible_create_course_button(self) -> None:
    ...
    def check_visible_course_card(
        self, index: int, title: str, max_score: str, min_score: str, estimated_time: str
    ) -> None:
